...
.cell-input input { width: 100%; height: 100%; box-sizing: border-box; border: none; padding: 12px; font-size: 1rem; text-align: right; background: #fafafa; outline: none; font-family: monospace; font-weight: bold;}
